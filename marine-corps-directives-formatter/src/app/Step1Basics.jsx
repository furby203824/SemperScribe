 ...
 * @property {'mco' | 'mcbul'} documentType
 * @property {'marine-corps' | 'navy'} letterheadType
 * @property {'times' | 'courier'} bodyFont
 * @property {'contingent' | 'fixed'} [cancellationType]
 * @property {string} [cancellationDate]
 * @property {string} [cancellationContingency]
 */

/**
 * @typedef {object} Step1BasicsProps
 * @property {FormData} formData
 * @property {React.Dispatch<React.SetStateAction<any>>} setFormData
 * @property {(date: string) => string} parseAndFormatDate
 */

/** @param {Step1BasicsProps} props */
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <label style={{
              ...
              backgroundColor: formData.letterheadType === 'navy'
                ? 'linear-gradient(135deg, #002D72 0%, #0047AB 100%)'
                : 'white',
          ...
          <CardContent>
                ...
                <label style={{
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData((prev) => ({ 
                      ...prev, 
                      cancellationType: e.target.value,
                      cancellationContingency: '' // Clear contingency if fixed
                    }))}
                    style={{ marginRight: '8px' }}
                  />
                  <div>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <input
                ...
                onChange={(e) => setFormData((prev) => ({ 
                  ...prev, 
                  cancellationDate: parseAndFormatDate(e.target.value)
                }))}
                style={{
                  padding: '12px',
                  fontSize: '1rem',
            ...
            {formData.cancellationType === 'contingent' && (
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setFormData((prev) => ({ 
                    ...prev, 
                    cancellationContingency: e.target.value
                  }))}
                  style={{
                    padding: '12px',
                    fontSize: '1rem',
