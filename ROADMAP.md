...
| Type | Status | Notes |
|------|--------|-------|
| Standard Letter | DONE | Default format for official correspondence outside the command |
| Multiple-Address Letter | TODO | Same as Standard Letter but addresses multiple recipients (e.g., "Distribution List") |
| Endorsement (Same-Page) | DONE | Continues on the original page if space permits |
| Endorsement (New-Page) | DONE | Starts on a fresh page |
...
| Type | Status | Notes |
|------|--------|-------|
| Memorandum for the Record (MFR) | TODO | No "To:" line. Documents events internally. Uses plain paper (no letterhead) |
| "From-To" Memorandum | TODO | Informal, internal routine business. Uses plain paper or authorized command memo forms |
| Letterhead Memorandum | TODO | Formal memo to senior officials. Uses Command Letterhead but keeps "From/To" structure |
| Decision Memorandum | TODO | Requires an "Approve / Disapprove" block at the bottom |
| Memorandum of Agreement/Understanding (MOA/MOU) | TODO | Requires side-by-side or stacked signature blocks for all parties |
...
| Type | Status | Notes |
|------|--------|-------|
| Point Paper | TODO | Single page. Rigid bullet structure. Present key issues quickly |
| Talking Paper | TODO | Narrative outline (script-like). Guide a discussion |
| Briefing Paper | TODO | Detailed version of Talking Paper. Background and discussion |
| Position Paper | TODO | Articulates official stance on a specific issue |
| Trip Report | TODO | Reports results of official travel (defined in MCO 5216.20A) |
...
| Type | Status | Notes |
|------|--------|-------|
| Business Letter | TODO | Writing to civilians/private businesses. "Dear Mr. Smith," / "Sincerely," format |
| Executive Correspondence | TODO | Letters to President, Congress, SecDef. Strict formatting (specific margins, bond paper) |

### Other Document Types

| Type | Status | Notes |
|------|--------|-------|
| AMHS Message (GENADMIN/MARADMIN) | DONE | DTG, references, NARR, POC, validation, terminal preview |
| MCO (Marine Corps Order) | DONE | Directives with distribution statements and reports required |
| MCBul (Bulletin) | DONE | Time-limited directives with cancellation date |
| AA Form (NAVMC 10274) | DONE | Administrative Action form |
| Page 11 (NAVMC 118-11) | DONE | Administrative Remarks |
...
- MCO 5216.20A (Marine Corps Correspondence Manual)
